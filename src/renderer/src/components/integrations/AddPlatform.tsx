...
import { CheckCircle2, AlertCircle, Eye, EyeOff, ArrowRight, Key, Clock } from 'lucide-react'
...
const OAUTH_PROVIDERS: { provider: IntegrationProvider; name: string; color: string; letter: string }[] = [
  { provider: 'google-classroom', name: 'Google Classroom',    color: '#4285F4', letter: 'G' },
  { provider: 'microsoft-teams',  name: 'Microsoft Teams EDU', color: '#6264A7', letter: 'T' },
]
